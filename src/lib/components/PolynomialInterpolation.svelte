<script>
  ...
  function interpolate() {
    // Implementar la lógica de interpolación polinómica aquí
    result = "Polynomial interpolation not implemented yet";
  }
</script>

<InterpolationBase title="Polynomial Interpolation Calculator" on:pointsUpdated={(e) => points = e.detail}>
